...
public class ConfigGenerator {
     ...
     * @param pluginName              Formatted plugin name that is used for messages
    ...
    public static CommandGroupNode generateConfigCommand(
        ...
        return generateConfigCommand(instance, saveCallback, loadCallback, pluginName, "config");
    }
     ...
     * @param loadCallback            Runnable to call when the "load" subcommand is executed.
     * @param pluginName              Formatted plugin name that is used for messages
     * @param commandName             The name of the CommandGroupNode generated by the function
     * @return A CommandGroupNode with `edit`, `save`, and `load` subcommands.
     */
    public static CommandGroupNode generateConfigCommand(
            Object instance,
